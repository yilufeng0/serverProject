              ...
              <div class="row">
                  ...
                  <div class="col-lg-10 main-chart">  
                    ...
                    <table class="table table-striped table-hover">
                      <thead class="">
                        <tr>
                          ...
                          <!-- 通过点击 -->
                          <th class="col-sm-1 text-center">版本号</th>
                          <th class="col-sm-2 text-center">提交日期</th>                        
                    ...
                    <jsp:include page="loadmore.jsp">
                    			<jsp:param value="appload" name="loadType"/>
                    			<jsp:param value="<%=request.getParameter(\"apptype\")%>" name="apptype"/>
                    </jsp:include>
