...
public class UpdateOperation {
	 ...
	 * @return 返回数据操作的结果
	 */
	public static boolean UpdateOne(String sql,List<Object> param){
		if (param.size()<=0) {
			return false;
		}
		try {
...
//		JDBCConnect.free(null, conn, pstm);
	 ...
	 * @return
	 */
	public static boolean UpdateOne(String sql,int id){
...
//		JDBCConnect.free(null, conn, pstm);
	...
	public static boolean Updateones(String sql){
		try {
